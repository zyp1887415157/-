...
public class SendMail {
    ...
    public static final String myEmailAccount = "1554361032@qq.com";
    public static final String myEmailPassword = "bugvqfumtziagfcb";
    ...
    public static MimeMessage createMimeMessage(Session session, String sendMail, String receiveMail) throws Exception {
        ...
        // 2. From: 发件人
        message.setFrom(new InternetAddress(sendMail, "奥特曼", "UTF-8"));

        // 3. To: 收件人（可以增加多个收件人、抄送、密送）
        message.setRecipient(MimeMessage.RecipientType.TO, new InternetAddress(receiveMail, "XX用户", "UTF-8"));

        // 4. Subject: 邮件主题
        message.setSubject("秘密", "UTF-8");

        // 5. Content: 邮件正文（可以使用html标签）
        message.setContent("你是被选中的孩子", "text/html;charset=UTF-8");
        // 6. 设置发件时间
