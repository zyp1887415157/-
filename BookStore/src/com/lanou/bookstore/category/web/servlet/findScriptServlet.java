...
@WebServlet(name = "findScriptServlet", urlPatterns = "/findScript")
public class findScriptServlet extends HttpServlet {
    private CategoryService2 categoryService2 = new CategoryService2();

    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        List<Category> categories = categoryService2.getResult("3");
